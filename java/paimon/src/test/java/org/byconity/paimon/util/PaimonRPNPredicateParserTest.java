...
public class PaimonRPNPredicateParserTest extends PaimonTestBase {
    ...
    private boolean enableFailOnParseError() {
        try {
            Class<?> clazz = AbstractRPNPredicateParser.class;
    ...
    public void testEquals() {
        Predicate predicate = PaimonRPNPredicateParser.parse(table,
        ...
        try {
            IllegalStateException illegalStateException = Assert.assertThrows(
                    IllegalStateException.class, () -> PaimonRPNPredicateParser.parse(table,
    ...
    public void testLessThan() {
        ...
        try {
            IllegalStateException illegalStateException = Assert.assertThrows(
                    ...
                    () -> Assert.assertNull(PaimonRPNPredicateParser.parse(table,
    ...
    public void testIsNull() {
        Predicate predicate =
                PaimonRPNPredicateParser.parse(table, "@function(isNull,1)@identifier(col_int)");
    ...
    public void testIsNotNull() {
        Predicate predicate =
                PaimonRPNPredicateParser.parse(table, "@function(isNotNull,1)@identifier(col_int)");
    ...
    public void testAndOr() {
        ...
        predicate = PaimonRPNPredicateParser.parse(table,
