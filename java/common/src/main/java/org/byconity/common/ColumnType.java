...
public class ColumnType {
    ...
    public enum TypeValue {
        UNKNOWN, TINYINT, BYTE, BOOLEAN, SHORT, INT, LONG, FLOAT, DOUBLE, BINARY, STRING, DATE,
        ...
        DATETIME_MILLIS, DECIMAL64, DECIMAL128, ARRAY, MAP, STRUCT,
    }
    ...
    private static final Map<TypeValue, String> PRIMITIVE_TYPE_VALUE_STRING_MAPPING =
            new HashMap<>();
    ...
    static {
        ...
        // varchar and char for hive, must put after PRIMITIVE_TYPE_VALUE_STRING_MAPPING is
        // generated
    ...
    private void parseStruct(List<String> childNames, List<ColumnType> childTypeValues,
    ...
    public boolean isDecimal() {
        return typeValue == TypeValue.DECIMAL64 || typeValue == TypeValue.DECIMAL128;
    }
        ...
        switch (typeValue) {
            ...
            default:
                throw new UnsupportedOperationException(
                        "Only datetime type family supports getTimeUnit. Got "
                                + getTypeValueString());
        }
    }
    ...
    private TypeValue parseDecimal(String rawType) {
        ...
        if (s != -1 && e != -1) {
            ...
            // type = "decimal128";
            // }
            /// clickhouse's arrow lib does not support decimal64
            type = "decimal128";
        }
